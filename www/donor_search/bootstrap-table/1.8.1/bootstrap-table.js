...
! function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            html = [];
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search" style="width: 40%">',
                sprintf('<input id="search_str" class="form-control' + (this.options.iconSize === undefined ? '' : ' input-' + this.options.iconSize) + '" type="text" placeholder="%s">',
    ...
    BootstrapTable.prototype.refresh = function (params) {
        ...
        e.keyCode = 13;
        $('#search_str').val('').focus().trigger(e);
